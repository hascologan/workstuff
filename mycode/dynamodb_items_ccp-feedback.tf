resource "aws_dynamodb_table_item" "item1" {
    ...
    for_each = {
        ...
        "ccp-feedback-6" = {
            datetime = "2019/12/18 12:59:13"
            description = "Great work! This is the best tool ever!"
            email = "blah@blah.com"
        }
        "ccp-feedback-7" = {
            datetime = "2020/11/04 09:49:06"
